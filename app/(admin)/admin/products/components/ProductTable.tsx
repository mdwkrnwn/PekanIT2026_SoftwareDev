...
export default function ProductTable({
  ...
  return (
    <div className="overflow-x-auto rounded-2xl border border-[#EAECF0] bg-white">
      <table className="overflow-x-auto min-w-3xl">
        {/* Header */}
        <thead>
          <tr className="text-left grid grid-cols-[3fr_1fr_1fr_1fr_1fr_90px] border-b border-[#EAECF0] bg-[#FCFCFD] px-6 py-4 text-[15px] font-semibold text-[#667085]">
            <th>Produk</th>
            <th>Kategori</th>
            <th>Harga</th>
            <th>Dilihat</th>
        ...
        <tbody>
          <tr>
            ...
            {loading ? (
              ...
              <td className="flex h-64 items-center justify-center">
              ...
              products.map((item) => (
                ...
                >
                  {/* Produk */}
                  <div className="md:flex grid grid-cols-1 items-center gap-4">
                    <Image
                      src={item.image}
                      alt={item.name}
                      width={70}
