...
export function Testimonials() {
  return <div className="bg-primary md:py-16 flex flex-row justify-center w-screen px-5 py-8 mt-16 overflow-hidden text-white" >
    <div className="w-full md:w-[86vw] flex flex-col justify-center md:flex-row gap-4 items-center lg:*:w-1/2 *:w-full">
      <div className="md:w-[35%]">
        <h3 className="mb-2 wrap-break-word text-[clamp(1.5rem,3.125rem,3vw)] font-bold">Kata Mereka Tentang UFinder 👀</h3>
        <p className="opacity-90 md:mb-8 wrap-break-word text-[clamp(1.25rem,2rem,2vw)]">Pengalaman seru dari pengguna yang sudah dukung UMKM lokal.</p>
        <button className="hover:bg-slate-100 text-primary-foreground md:flex items-center hidden gap-2 px-6 py-3 font-bold transition-colors bg-white rounded-full">
