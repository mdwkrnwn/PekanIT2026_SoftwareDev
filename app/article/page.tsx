  ...
  return (
    <>
      ...
      <section className="grid gap-10 xl:grid-cols-[2fr_1fr]">
        {/* Main Content */}
        <article>
          <span className="border-primary text-primary inline-flex rounded-full border px-5 py-2 text-sm font-bold">
            Tips & Edukasi
          </span>

          <h1 className="text-foreground mt-8 max-w-4xl text-6xl font-bold leading-tight">
          ...
          <div className="mt-10 flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <button className="border-primary hover:bg-primary hover:text-white flex size-16 items-center justify-center rounded-full border text-primary transition-colors">
                <FaHeart size={25} />
              </button>

              <button className="border-primary text-primary hover:bg-primary hover:text-white flex size-16 items-center justify-center rounded-full border transition-colors">
                <FaBookmark size={25} />
              </button>
