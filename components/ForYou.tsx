  ...
  return (
    <div className="w-[80vw] mx-auto mt-16">
      ...
      <div className="lg:grid-cols-4 md:grid-cols-2 grid gap-6">
        {['Kafe', 'Jajanan', 'Hobi', 'Toko Kelontong'].map((cat, i) => <Link href={'/explore?category=' + cat.replace(" ", "+")} key={i} className="rounded-2xl group relative h-48 overflow-hidden cursor-pointer">
