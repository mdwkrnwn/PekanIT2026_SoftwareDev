  ...
  return (
    <section className="relative w-[80vw] mt-15">
      ...
      <div
        data-aos="fade-up"
        data-aos-delay="200"
        className="mx-auto mt-20 grid grid-cols-1 gap-6 rounded-[2rem] bg-background p-8 outline-3 outline-[#EEF0F2] md:grid-cols-2 lg:grid-cols-4"
      >
        {stats.map((item, index) => (
          <div
            ...
            className="flex items-center gap-5 pr-8 lg:border-r border-[#EEF0F2] last:lg:border-r-0"
          >
